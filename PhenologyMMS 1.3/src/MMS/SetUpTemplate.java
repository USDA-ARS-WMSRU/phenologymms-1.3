...
public class SetUpTemplate extends JFrame {
...
// end of declarations    
     ...
     */
    public SetUpTemplate(Frame SGHF, OutPutFrame OPF, Parameters myPara) {
        myParameters = myPara;
        myHelpFrame = SGHF;
        myOutputFrame = OPF;
        try {
            ...
            this.setParameters();
            this.setSize(700, 500);//(width, height)
     ...
     */
    public SetUpTemplate(Frame SGHF, OutPutFrame OPF, Parameters myPara, StringTokenizer st) {
//this constructor is for loading a scenario from a file
    ...
    private void jbInit() throws Exception {
        ...
        // set the text fields and radio buttons        
            ...
            //text fields and radio buttons 1-15 for jGDDPanel
        ...
        jRBNumber15.setText("Number15");
        
         //text fields and radio buttons 16-30 for jPanelGDDStress
        ...
        jRBNumber30.setText("Number30");
        
            //text fields and radio buttons 31-45 for jLVSPanel         
        ...
        jRBNumber45.setText("Number45");

            //text fields and radio buttons 46-60 for jPanelLVSStress
       ...
       // jRBNumber60.setMinimumSize(new Dimension(80, 23));
        ...
        // There are 15 groups with 4 radio buttons each. 
...
//DE added this method
    ...
    /**
     *  Sets the window attribute of the SetUpTemplate object
     *
...
//  *************************** we populate the window
        jTitleLabel.setText(myGrowthStates.myType + " Template for Growth Stages");
...
//        set ROW15 Radio button
  ...
  // bcv added path find
    ...
    /**
     *  Gets the varieties attribute of the SetUpTemplate object
     *
    ...
    private GrowthStages getVarieties() throws IOException {
        ...
        for (int i = 0; i < myVarFiles.length; i++) {
            ...
            //if (myVarFiles[i].getName().equalsIgnoreCase("Template.txt")) {
            if (myVarFiles[i].getName().equalsIgnoreCase("Template.dat")) {
                myFile = myVarFiles[i];
                try {
                    input = new BufferedReader(new FileReader(myFile));
                } catch (Exception ex) {
                    System.out.println("Can't open template file: " + ex);
                }
...
//        reset all the radio buttons to default
    ...
    /**
     *  Sets the parameters attribute of the SetUpTemplate object
     */
