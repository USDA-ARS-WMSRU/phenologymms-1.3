...
public class SFSetGDDFrame extends JFrame {
...
// end of declarations            
     ...
     */
    public SFSetGDDFrame(Frame SGHF, OutPutFrame OPF, Parameters myPara) {
        myParameters = myPara;
        myHelpFrame = SGHF;
        myOutputFrame = OPF;
        try {
     ...
     */
    public SFSetGDDFrame(Frame SGHF, OutPutFrame OPF, Parameters myPara, StringTokenizer st) {
//this constructor is for loading a scenario from a file
        ...
        try {
            ...
            this.getVarieties();
            this.setWindow(myParameters.myStages);
    ...
    private void jbInit() throws Exception {
        ...
        jRBNumber3.setText("V4 to 8th Leaf (V8)");
        ...
        jRBNumber4.setText("V8 to 12th Leaf (v12)");
        ...
        jRBNumber5.setText("V12 to Flower Visible (R1)");
        ...
        jRBNumber6.setText("R1 to Int Elong (R2)");
        ...
        jRBNumber7.setText("R2 to Int Elong > 2 (R3)");
        ...
        jRBNumber8.setText("R3 to Flower Opens (R4)");
        ...
        jRBNumber9.setText("R4 to Anthesis Starts (R5)");
        ...
        jRBNumber10.setText("R5 to Anthesis Ends (R6)");
        ...
        jRBNumber11.setText("R6 to Flower Yellow (R7)");
        ...
        jRBNumber12.setText("R7 to Flower Brown (R8)");
        ...
        jRBNumber13.setText("R8 to Maturity (R9)");  
        ...
        jRBNumber14.setText("R9 to Harvest Ready");          
        ...
        jRBNumber17.setText("V4 to 8th Leaf (V8)");
        ...
        jRBNumber18.setText("V8 to 12th Leaf (v12)");
        ...
        jRBNumber19.setText("V12 to Flower Visible (R1)"); 
        ...
        jRBNumber20.setText("R1 to Int Elong (R2)");
        ...
        jRBNumber21.setText("R2 to Int Elong > 2 (R3)"); 
        ...
        jRBNumber22.setText("R3 to Flower Opens (R4)");
        ...
        jRBNumber23.setText("R4 to Anthesis Starts (R5)");
        ...
        jRBNumber24.setText("R5 to Anthesis Ends (R6)");
        ...
        jRBNumber25.setText("R6 to Flower Yellow (R7)");
        ...
        jRBNumber26.setText("R7 to Flower Brown (R8)");
        ...
        jRBNumber27.setText("R8 to Maturity (R9)");
        ...
        jRBNumber28.setText("R9 to Harvest Ready");        
        ...
        jRBNumber31.setText("V4 to 8th Leaf (V8)");
        ...
        jRBNumber32.setText("V8 to 12th Leaf (v12)");
        ...
        jRBNumber33.setText("V12 to Flower Visible (R1)");
        ...
        jRBNumber34.setText("R1 to Int Elong (R2)");
        ...
        jRBNumber35.setText("R2 to Int Elong > 2 (R3)");
        ...
        jRBNumber36.setText("R3 to Flower Opens (R4)");
        ...
        jRBNumber37.setText("R4 to Anthesis Starts (R5)");
        ...
        jRBNumber38.setText("R5 to Anthesis Ends (R6)");
        ...
        jRBNumber39.setText("R6 to Flower Yellow (R7)");
        ...
        jRBNumber40.setText("R7 to Flower Brown (R8)");
        ...
        jRBNumber41.setText("R8 to Maturity (R9)");
        ...
        jRBNumber42.setText("R9 to Harvest Ready");        
        ...
        jRBNumber45.setText("V4 to 8th Leaf (V8)");
        ...
        jRBNumber46.setText("V8 to 12th Leaf (v12)");
        ...
        jRBNumber47.setText("V12 to Flower Visible (R1)");              
        ...
        jRBNumber48.setText("R1 to Int Elong (R2)");
        ...
        jRBNumber49.setText("R2 to Int Elong > 2 (R3)");
        ...
        jRBNumber50.setText("R3 to Flower Opens (R4)");
        ...
        jRBNumber51.setText("R4 to Anthesis Starts (R5)");
        ...
        jRBNumber52.setText("R5 to Anthesis Ends (R6)");
        ...
        jRBNumber53.setText("R6 to Flower Yellow (R7)");
        ...
        jRBNumber54.setText("R7 to Flower Brown (R8)");
        ...
        jRBNumber55.setText("R8 to Maturity (R9)");
        ...
        jRBNumber56.setText("R9 to Harvest Ready");
        ...
        // There are 13 groups with 4 radio buttons each. 
    ...
    /**
     *  Sets the backReferance attribute of the SFSetGDDFrame object
     *
...
//DE added this method
    ...
    /**
     *  Sets the window attribute of the WWSetGDDFrame object
     *
     *@param  myGrowthStates  The new window value
     *@exception  Exception   Description of the Exception
     */
    public void setWindow(GrowthStages myGrowthStates) throws Exception {
...
//  *************************** we populate the window
        jTitleLabel.setText(myGrowthStates.myType + " Sunflower Growth Stages");
...
//        set ROW14 Radio button
  ...
  // bcv added path find
    ...
    /**
     *  Gets the varieties attribute of the SFSetGDDFrame object
     *
     *@return                  The varieties value
     *@exception  IOException  Description of the Exception
     */
    private GrowthStages getVarieties() throws IOException {
        //    **************  get varieties ******************
        File[] myVarFiles;
        File myFile;
        ...
        GrowthStages thisStage = null;

        myVarFiles = varFiles.getFiles();
        for (int i = 0; i < myVarFiles.length; i++) {
            //debe changed the file extensions to .dat
            //if (myVarFiles[i].getName().equalsIgnoreCase("Sunflower.txt")) {
            if (myVarFiles[i].getName().equalsIgnoreCase("Sunflower.dat")) {
                myFile = myVarFiles[i];
                try {
                    input = new BufferedReader(new FileReader(myFile));
                } catch (Exception ex) {
                    System.out.println("Can't open sunflower file: " + ex);
                }
...
// *********** make sure that the Generic variety is set as default
        for (int i = 0; i < allVarieties.size(); i++) {
            thisStage = (GrowthStages) allVarieties.get(i);
    ...
    void jCBVarietyType_actionPerformed(ActionEvent e) {
        GrowthStages tmpStage;

        for (int i = 0; i < allVarieties.size(); i++) {
            tmpStage = (GrowthStages) allVarieties.get(i);
...
//        reset all the radio buttons to default
    ...
    /**
     *  Sets the parameters attribute of the SFSetGDDFrame object
     */
...
//        pass parameters to output frame
    ...
    /**
     *  Gets the Acode attribute of the SFSetGDDFrame object
     *
    ...
    private String getAcode(String col) {
        ...
        return "1";
    }// end of getAcode method


    /**
     *  Sets the growthStages attribute of the SetUpTemplate object, used when
    ...
    }// end of setGrowthStages method


    /**
     *  Sets the radioButton attribute of the SFSetGDDFrame object
     *
