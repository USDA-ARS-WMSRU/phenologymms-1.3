...
public class SWSetGDDFrame extends JFrame {
...
// end of declarations   
     ...
     */
    public SWSetGDDFrame(Frame SGHF, OutPutFrame OPF, Parameters myPara, StringTokenizer st) {
//this constructor is for loading a scenario from a file
        ...
        try {
            ...
            this.getVarieties();
            this.setWindow((SWGrowthStages) myParameters.myStages);
    ...
    private void jbInit() throws Exception {
        ...
        jGDDPanel.setSize(new Dimension(400, 30));// was 200, 30
        ...
        jRBNumber5.setText("DR to Terminal Spikelet");
        ...
        jRBNumber6.setText("TS to Jointing");
        ...
        jRBNumber20.setText("DR to Terminal Spikelet");
        ...
        jRBNumber21.setText("TS to Jointing");
        ...
        jRBNumber34.setText("DR to Terminal Spikelet");
        ...
        jRBNumber35.setText("TS to Jointing");
        ...
        jRBNumber49.setText("DR to Terminal Spikelet");
        ...
        jRBNumber50.setText("TS to Jointing");
...
//DE added this method
    ...
    /**
     *  Sets the window attribute of the SWSetGDDFrame object
     *
     *@param  myGrowthStates  The new window value
     *@exception  Exception   Description of the Exception
     */
    public void setWindow(SWGrowthStages myGrowthStates) throws Exception {
...
//  *************************** we populate the window
        jTitleLabel.setText(myGrowthStates.myType + " Spring Wheat Growth Stages");
...
//        set ROW11 Radio button
  ...
  // bcv added path find
    ...
    /**
     *  Gets the varieties attribute of the SWSetGDDFrame object
     *
     *@return                  The varieties value
     *@exception  IOException  Description of the Exception
     */
    private SWGrowthStages getVarieties() throws IOException {
        //    **************  get varieties ******************
        File[] myVarFiles;
        File myFile;
        ...
        SWGrowthStages thisStage = null;

        myVarFiles = varFiles.getFiles();
        for (int i = 0; i < myVarFiles.length; i++) {
            //if (myVarFiles[i].getName().equalsIgnoreCase("Spring Wheat.txt")) {
             if (myVarFiles[i].getName().equalsIgnoreCase("Spring Wheat.dat")) {
                myFile = myVarFiles[i];
                try {
                    input = new BufferedReader(new FileReader(myFile));
                } catch (Exception ex) {
                    System.out.println("Can't open spring wheat file: " + ex);
                }
...
// *********** make sure that the Generic variety is set as default
        for (int i = 0; i < allVarieties.size(); i++) {
            thisStage = (SWGrowthStages) allVarieties.get(i);
            if (thisStage.myType.equalsIgnoreCase("Generic")) {//de changed default to 8-leaved variety. Later changed default to 'Generic'
                return thisStage;
            }
        }
        return thisStage;
    ...
    void jCBVarietyType_actionPerformed(ActionEvent e) {
        SWGrowthStages tmpStage;

        for (int i = 0; i < allVarieties.size(); i++) {
            tmpStage = (SWGrowthStages) allVarieties.get(i);
...
//        reset all the radio buttons to default
    ...
    /**
     *  Sets the parameters attribute of the SWSetGDDFrame object
     */
...
//        pass parameters to output frame
    ...
    /**
     *  Gets the Acode attribute of the SWSetGDDFrame object
     *
    ...
    /**
     *  Sets the growthStages attribute of the SWSetGDDFrame object, used when
    ...
    /**
     *  Sets the radioButton attribute of the SWSetGDDFrame object
     *
