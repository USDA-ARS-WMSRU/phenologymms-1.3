...
//    //old way of accessing help text files
    ...
    // trying to access a .chm help file
// void jBHelp_actionPerformed(ActionEvent e) {
//        if (helpOn == true) {
//            System.out.println("helpOn = " + helpOn);
//            System.out.println("In Help_actionPerformed before call to Desktop class");
//           myDesktopEg = new DesktopEg();
//           System.out.println("After call to Desktop");
//           helpOn = false;
//        } else {
//            helpOn = true;
//        }
    ...
    void jCBCrop_itemStateChanged(ItemEvent e) {
       //these are the default values by crop that get loaded in the input frame
        ...
        if (myParameters.cropType.equalsIgnoreCase("corn")) {
            myParameters.plantingDate = myParameters.plantingDate_ORG = "04/25/2004"; 
            ...
            myParameters.plantingDate = myParameters.plantingDate_ORG = "06/01/2004";
            ...
            myParameters.plantingDate = myParameters.plantingDate_ORG = "09/09/2004";     
            ...
            myParameters.plantingDate = myParameters.plantingDate_ORG = "04/05/2004"; 
            myParameters.plantingDepth = myParameters.plantingDepth_ORG = "4";
            ...
            myParameters.plantingDate = myParameters.plantingDate_ORG = "03/23/2004"; 
            myParameters.plantingDepth = myParameters.plantingDepth_ORG = "4";
            ...
            myParameters.plantingDate = myParameters.plantingDate_ORG = "06/07/2004"; 
            ...
            //de added          
            myParameters.baseTemp = myParameters.baseTemp_ORG = "0";
            myParameters.optimumTempLow = myParameters.optimumTempLow_ORG = "20";
            myParameters.optimumTempUp = myParameters.optimumTempUp_ORG = "24";
            myParameters.upperTemp = myParameters.upperTemp_ORG = "40";
            myParameters.canopyHt = myParameters.canopyHt_ORG = "90.0";
            ...
            myParameters.plantingDate = myParameters.plantingDate_ORG = "05/28/2004"; 
        ...
        //    myParameters.cropType = jCBCrop.getSelectedItem().toString().trim();
            ...
            myParameters.baseTemp = myParameters.baseTemp_ORG = "0";
            myParameters.optimumTempLow = myParameters.optimumTempLow_ORG = "18";
            myParameters.optimumTempUp = myParameters.optimumTempUp_ORG = "18";
            myParameters.upperTemp = myParameters.upperTemp_ORG = "40";
            myParameters.canopyHt = myParameters.canopyHt_ORG = "90.0";
        }
