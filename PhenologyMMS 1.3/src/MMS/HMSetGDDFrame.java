 ...
 *@version       1.0
 *
 *This class was added by Debbie Edmunds, July, 2005
 */

public class HMSetGDDFrame extends JFrame {
...
// end of declarations   
    ...
    /**
     *  Constructor for the HMSetGDDFrame object
     *
     *@param  SGHF    for the help frame
     *@param  OPF     for the output frame
     *@param  myPara  the parameters for hay millet
     */
    public HMSetGDDFrame(Frame SGHF, OutPutFrame OPF, Parameters myPara) {
        myParameters = myPara;
        myHelpFrame = SGHF;
        myOutputFrame = OPF;
        try {
     ...
     *  Constructor for the HMSetGDDFrame object
     *
     *@param  SGHF    Help frame
     *@param  OPF     Output frame
     *@param  myPara  Hay millet parameters
     *@param  st      StringTokenizer
     */
    public HMSetGDDFrame(Frame SGHF, OutPutFrame OPF, Parameters myPara, StringTokenizer st) {
//this constructor is for loading a scenario from a file
        ...
        try {
            ...
            this.getVarieties();
            this.setWindow((HMGrowthStages) myParameters.myStages);
    ...
    private void jbInit() throws Exception {
        ...
        jRBNumber3.setText("E to Single Ridge");
        ...
        jRBNumber5.setText("DR to End Spikelet Init");
        ...
        jRBNumber6.setText("ESI to Jointing");
        ...
        jRBNumber18.setText("E to Single Ridge");
        ...
        jRBNumber20.setText("DR to End Spikelet Init");
        ...
        jRBNumber21.setText("ESI to Jointing");
        ...
        jRBNumber32.setText("E to Single Ridge");
        ...
        jRBNumber34.setText("DR to End Spikelet Init");
        ...
        jRBNumber35.setText("ESI to Jointing");
        ...
        jRBNumber47.setText("E to Single Ridge");
        ...
        jRBNumber49.setText("DR to End Spikelet Init");
        ...
        jRBNumber50.setText("ESI to Jointing");
        ...
        //add the jNorthPanel to the jMainPanel and add title
    ...
    /**
     *  Sets the backReferance attribute of the SWSetGDDFrame object
     *
     ...
     *  Description of the Method
     *
     *@param  e  Determines whether to go back to the previous screen
     */
     ...
     *  Description of the Method
     *
     *@param  e  Determines whether to run the model
     */
...
//DE added this method
    ...
    /**
     *  Sets the window attribute of the HMSetGDDFrame object
     *
     *@param  myGrowthStates  The new window value
     *@exception  Exception   Description of the Exception
     */
    public void setWindow(HMGrowthStages myGrowthStates) throws Exception {
...
//  *************************** we populate the window
        jTitleLabel.setText(myGrowthStates.myType + " Hay Millet Growth Stages");
...
//        set ROW11 Radio button
    ...
    /**
     *  Gets the varieties attribute of the HMSetGDDFrame object
     *
     *@return                  The varieties value
     *@exception  IOException  Description of the Exception
     */
    private HMGrowthStages getVarieties() throws IOException {
        //    **************  get varieties ******************
        File[] myVarFiles;
        File myFile;
        ...
        HMGrowthStages thisStage = null;

        myVarFiles = varFiles.getFiles();
        for (int i = 0; i < myVarFiles.length; i++) {
            //if (myVarFiles[i].getName().equalsIgnoreCase("Hay Millet.txt")) {
            if (myVarFiles[i].getName().equalsIgnoreCase("Hay Millet.dat")) {
                myFile = myVarFiles[i];
                try {
                    input = new BufferedReader(new FileReader(myFile));
                } catch (Exception ex) {
                    System.out.println("Can't open hay millet file: " + ex);
                }
...
// *********** make sure that the Generic variety is set as default
        for (int i = 0; i < allVarieties.size(); i++) {
            thisStage = (HMGrowthStages) allVarieties.get(i);
    ...
    void jCBVarietyType_actionPerformed(ActionEvent e) {
        HMGrowthStages tmpStage;

        for (int i = 0; i < allVarieties.size(); i++) {
            tmpStage = (HMGrowthStages) allVarieties.get(i);
...
//        reset all the radio buttons to default
    ...
    /**
     *  Sets the parameters attribute of the HMSetGDDFrame object
     */
...
//        pass parameters to output frame
    ...
    /**
     *  Gets the aCode attribute of the HMSetGDDFrame object
     *
    ...
    /**
     *  Sets the growthStages attribute of the HMSetGDDFrame object, used when
    ...
    /**
     *  Sets the radioButton attribute of the HMSetGDDFrame object
     *
