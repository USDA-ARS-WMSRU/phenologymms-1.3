...
public class SGSetGDDFrame extends JFrame {
...
// end of declarations    
     ...
     */
    public SGSetGDDFrame(Frame SGHF, OutPutFrame OPF, Parameters myPara, StringTokenizer st) {
//this constructor is for loading a scenario from a file
        ...
        try {
            ...
            this.getVarieties();
            this.setWindow((SGGrowthStages) myParameters.myStages);
    ...
    private void jbInit() throws Exception {
        ...
        // set the text fields and radio buttons        
            ...
            //text fields and radio buttons 1-12 for jGDDPanel
        ...
        jRBNumber3.setText("E to Internode Elong Starts");
        ...
        jRBNumber4.setText("IES to Jointing");
        ...
        jRBNumber5.setText("E to Growing Pt Diff");
        ...
        jRBNumber6.setText("GPD to End Leaf Growth");
        ...
        jRBNumber7.setText("ELG to Anthesis Start");
        ...
        jRBNumber8.setText("First Bloom(AS) to Half Bloom");
        ...
        jRBNumber9.setText("HB to Full Bloom");
        ...
        jRBNumber11.setText("M to Harvest Ready");
            ...
            //text fields and radio buttons 16-27 for jPanelGDDStress
        ...
        jRBNumber18.setText("E to Internode Elong Starts");
        ...
        jRBNumber19.setText("IES to Jointing");
        ...
        jRBNumber20.setText("E to Growing Pt Diff");       
        ...
        jRBNumber21.setText("GPD to End Leaf Growth");
        ...
        jRBNumber22.setText("ELG to Anthesis Start");
        ...
        jRBNumber23.setText("First Bloom(AS) to Half Bloom");
        ...
        jRBNumber24.setText("HB to Full Bloom");       
        ...
        jRBNumber26.setText("M to Harvest Ready");
            ...
            //text fields and radio buttons 30-41 for jLVSPanel
        ...
        jRBNumber32.setText("E to Internode Elong Starts");
        ...
        jRBNumber33.setText("IES to Jointing");
        ...
        jRBNumber34.setText("E to Growing Pt Diff");
        ...
        jRBNumber35.setText("GPD to End Leaf Growth");
        ...
        jRBNumber36.setText("ELG to Anthesis Start");
        ...
        jRBNumber37.setText("First Bloom(AS) to Half Bloom");
        ...
        jRBNumber38.setText("HB to Full Bloom");
        ...
        jRBNumber40.setText("M to Harvest Ready");
            ...
            //text fields and radio buttons 45-56 for jPanelLVSStress
        ...
        jRBNumber47.setText("E to Internode Elong Starts");
        ...
        jRBNumber48.setText("IES to Jointing");
        ...
        jRBNumber49.setText("E to Growing Pt Diff");
        
        jTFNumber50.setHorizontalAlignment(SwingConstants.CENTER);
        jRBNumber50.setText("GPD to End Leaf Growth");
        ...
        jRBNumber51.setText("ELG to Anthesis Start");        
        ...
        jRBNumber52.setText("First Bloom(AS) to Half Bloom");       
        ...
        jRBNumber53.setText("HB to Full Bloom");        
    ...
    void jHelpButton_actionPerformed(ActionEvent e) {
		if(RoboHelp.openHelpPage("Growth_Stages/Sorghum_Growth_Stages.htm")) {
			return;
		}
    ...
    /**
     *  Sets the backReferance attribute of the WWSetGDDFrame object
     *
    ...
    /**
     *  Sets the window attribute of the SGSetGDDFrame object
     *
     *@param  myGrowthStates  The new window value
     *@exception  Exception   Description of the Exception
     */
    public void setWindow(SGGrowthStages myGrowthStates) throws Exception {
...
//  *************************** we populate the window
        jTitleLabel.setText(myGrowthStates.myType + " Sorghum Growth Stages");
...
//        set ROW11 Radio button
  ...
  // bcv added path find
    ...
    /**
     *  Gets the varieties attribute of the SGSetGDDFrame object
     *
     *@return                  The varieties value
     *@exception  IOException  Description of the Exception
     */
    private SGGrowthStages getVarieties() throws IOException {
        //    **************  get varieties ******************
        File[] myVarFiles;
        File myFile;
        ...
        SGGrowthStages thisStage = null;

        myVarFiles = varFiles.getFiles();
        for (int i = 0; i < myVarFiles.length; i++) {
            //debe changed the file extensions to .dat
            //if (myVarFiles[i].getName().equalsIgnoreCase("Sorghum.txt")) {
            if (myVarFiles[i].getName().equalsIgnoreCase("Sorghum.dat")) {
                myFile = myVarFiles[i];
                try {
                    input = new BufferedReader(new FileReader(myFile));
                } catch (Exception ex) {
                    System.out.println("Can't open sorghum file: " + ex);
                }
...
// *********** make sure that the Generic variety is set as default
        for (int i = 0; i < allVarieties.size(); i++) {
            thisStage = (SGGrowthStages) allVarieties.get(i);
    ...
    void jCBVarietyType_actionPerformed(ActionEvent e) {
        SGGrowthStages tmpStage;

        for (int i = 0; i < allVarieties.size(); i++) {
            tmpStage = (SGGrowthStages) allVarieties.get(i);
...
//        reset all the radio buttons to default
    ...
    /**
     *  Sets the parameters attribute of the SGSetGDDFrame object
     */
...
//        pass parameters to output frame
    ...
    /**
     *  Gets the Acode attribute of the SGSetGDDFrame object
     *
    ...
    /**
     *  Sets the SGGrowthStages attribute of the SetUpTemplate object, used when
    ...
    /**
     *  Sets the radioButton attribute of the SGSetGDDFrame object
     *
